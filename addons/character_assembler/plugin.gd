...
## Main plugin script for the Procedural Character Assembler.
## Registers the main screen panel for character creation and rigging.

const MainPanel = preload("res://addons/character_assembler/scenes/main_panel.tscn")
...
func _get_plugin_icon() -> Texture2D:
	# Use a built-in editor icon - Skeleton2D represents character rigging well
