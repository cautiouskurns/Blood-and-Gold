...
## Provides a spreadsheet-style interface for managing game data tables.

const MainPanel = preload("res://addons/data_table_editor/scenes/main_panel.tscn")
...
func _get_plugin_icon() -> Texture2D:
	return EditorInterface.get_editor_theme().get_icon("Spreadsheet", "EditorIcons")
